...
const whyChooseUs = [
  ...
  { icon: Users, title: "شراكة مع الأسرة", desc: "تحديثات يومية عبر تطبيق نشأة بالصور والتقارير والملاحظات." },
...
const faqItems = [
  ...
  },
  {
    ...
    a: "نستخدم تطبيق نشأة الذي يتيح لأولياء الأمور متابعة يوميات أطفالهم بالصور والتقارير والملاحظات اليومية، بالإضافة إلى كاميرات مراقبة متاحة.",
  },
  {
