...
const IMG = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663757302822/VRTDiShJGKYLuIoi.jpeg";
const IMG2 = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663757302822/KGXpVjjhGWULAtBV.jpeg";

export default function About() {
  return (
    <div>
      <SEOHead
        title="من نحن | مركز شجرة التعلم - حضانة بالظهران حي أجيال"
        description="تأسس مركز شجرة التعلم عام 2024 في حي أجيال بالظهران. منهج EYFS البريطاني للأطفال من عمر سنتين إلى 6 سنوات. بيئة تعليمية آمنة ومحفزة تنمّي ثقة الطفل."
        path="/about"
        keywords="من نحن مركز شجرة التعلم, حضانة حي أجيال, رؤية ورسالة المركز, منهج EYFS الظهران"
      />
      {/* Hero */}
